    ...
    return (
        <div className="flex flex-wrap justify-center items-center gap-4">
            <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <i className="fa-regular fa-address-card" style={{ color: '#000000', fontSize: '4rem' }}></i>
                <a href="#">
                    <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white mt-5">Noteworthy technology acquisitions 2021</h5>
                </a>
